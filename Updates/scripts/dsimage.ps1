...
function postDeployment
{
    ...
    robocopy /S /XO $imagedrive\Updates\DS\Copytoroot C:\
    X:\getdrivers.ps1 -compname $compname -imagedrive $imagedrive
    X:\dskeepname.ps1 $compname
}
function preCapture
{
    robocopy /S /XO $imagedrive\Updates\DS\Copytoroot C:\
...
{
    postDeployment
    Remove-Item -Path C:\Utilities\FirstRun.bat
}
<#
...
{
    $compname=X:\dsVerifyComputerName.ps1 $compname
